...
namespace E_Ticket_Pro_472
{
    public partial class window_Add_Id : Form
    {
        ...
        private void btn_Save_Id_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand insertcommand = new SqlCommand("insert into ID_table(ID_username,ID_password) values(@username , @password) ");
        ...
        private void btn_Delete_id_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    SqlCommand commad = new SqlCommand("delete from ID_table where ID_username='" + comboBox_selectTodelete.Text + "'");
        ...
        private void button_deleteAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    SqlCommand commad = new SqlCommand("truncate table ID_table ");
